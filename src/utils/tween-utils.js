...
export function tween(obj, config, duration, delay = 0) {
    return new Promise((resolve) => {
        ...
        const stepOpacity = opacity === undefined ? 0 : (opacity - obj.opacity) / steps;
        const stepScale = config.scale === undefined ? 0 : (config.scale - obj.scaleX) / steps;
        let currentStep = 0;
        function step() {
